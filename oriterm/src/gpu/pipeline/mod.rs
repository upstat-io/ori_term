...
///
/// Used by all pipelines for transparent window support.
///
/// Used for both pipelines to support transparent windows.
pub(super) const PREMUL_ALPHA_BLEND: BlendState = BlendState {
...
pub(super) const QUAD_PRIMITIVE: PrimitiveState = PrimitiveState {
